 ...
 * @author Fred
 */
public class RelatorioAgrupamentoCursoFuncController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RelatorioAgrupamentoCursoFuncController.class.getName()).log(Level.SEVERE, null, ex);
        } catch (SQLException ex) {
            Logger.getLogger(RelatorioAgrupamentoCursoFuncController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
